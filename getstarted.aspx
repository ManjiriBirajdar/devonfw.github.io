        ...
        <div class="col-md-offset-2 col-md-8">
			...
			<ul class="custom-counter steps">
				<li><h2>The devonfw guide <img src="images/book.png" width="30"></h2>
					<p>First things first. If you´re a developer just beginning with devonfw use <a href="https://coconet.capgemini.com/sf/frs/do/downloadFile/projects.apps2_devon/frs.devon_distribution.current_version/frs54540?dl=1">the devonfw guide</a> to get started!</p>
				...
				<li>
					...
					<p>You can download from Teamforge the devonfw 2.0 distribution, the <a href="https://coconet.capgemini.com/sf/frs/do/downloadFile/projects.apps2_devon/frs.devon_distribution.current_version/frs54537?dl=1"> devonfw development environment (1Gb ZIP file)</a>.</p>			
				</li>
				<li>
					...
					<table class="table table-bordered table-bordered-blue">
						...
						<tbody>
							<tr>
							  <td><a href="https://coconet.capgemini.com/sf/frs/do/downloadFile/projects.apps2_devon/frs.devon_distribution.current_version/frs54540?dl=1">Devonfw Guide</a></td>
