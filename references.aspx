...
<html lang="en">
 <head>
    ...
    <meta name="description" content="devonfw sales and marketing page">
    <meta name="author" content="Capgemini CSD2015">
    <link rel="icon" href="images/favicon.ico">

    <title>devonfw - Sales & Marketing</title>
			...
			<nav class="navbar navbar-default" role="navigation" id="menunav">
				...
				<nav class="collapse navbar-collapse" role="navigation" id="menu">
					<ul class="nav nav-justified">
						...
						<li><a class="cg_internal active" href="#">Sales & Marketing</a></li>
		...
		<div class="col-md-2" role="complementary">
			<nav class="bs-docs-sidebar hidden-print hidden-xs hidden-sm">
				<ul class="nav bs-docs-sidenav">
					...
					<li>
						<a href="#sec2">Internal Marketing</a>
					</li>
					<li>
					...
					<li>
						<a href="#sec4">Foundations of devonfw</a>
					</li>
				</ul>
				<br/>
