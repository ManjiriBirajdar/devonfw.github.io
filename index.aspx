			...
			<nav class="navbar navbar-default" role="navigation" id="menunav">
				...
				<nav class="collapse navbar-collapse" role="navigation" id="menu">
					<ul class="nav nav-justified">
						...
						<li><a class="cg_internal btn btn-primary" href="https://troom.capgemini.com/sites/vcc/devon/getstarted.aspx">Getting started</a></li>
					</ul>
				</nav>
			</nav>
		</div>
				...
				<div class="carousel-inner">
					...
					<div class="item">
						<div class="smallcenter">
							...
							<p><a href="collaboration.aspx">Join the devon-believers and contribute. Get started here...!</a></p>
						</div>
					</div>
				</div>
				<!-- Carousel nav -->
